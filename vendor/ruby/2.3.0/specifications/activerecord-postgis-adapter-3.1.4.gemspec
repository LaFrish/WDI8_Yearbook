# -*- encoding: utf-8 -*-
# stub: activerecord-postgis-adapter 3.1.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rgeo-activerecord>.freeze, [">= 4.0.4"])
      ...
      s.add_dependency(%q<rgeo-activerecord>.freeze, [">= 4.0.4"])
